...
# ==========================================
    ...
    with st.container():
        ...
        with c_conf2:
            ...
            # La ventana de volatilidad puede ser distinta a la de simulación
            vol_days = st.slider("Ventana Volatilidad (Lookback)", 3, 30, 7)
    ...
    if st.button("🚀 Ejecutar Simulación Histórica", use_container_width=True):
        ...
        if not address: st.error("Error: Falta dirección.")
            ...
            with st.spinner("Simulando..."):
                ...
                # Llamada al backtester definitivo
                ...
                if df_res is not None and not df_res.empty:
                    ...
                    st.info(f"**Rango Inicial:** ±{rango_pct:.1f}%. Entrada: {p_ini:.4f}. Límites: {min_p:.4f} - {max_p:.4f}")
